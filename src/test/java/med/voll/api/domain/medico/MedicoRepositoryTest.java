...
@DataJpaTest // carregar somente o contexto do jpa
@AutoConfigureTestDatabase(replace= AutoConfigureTestDatabase.Replace.NONE) // usar configuraçao do banco de dados padrao
